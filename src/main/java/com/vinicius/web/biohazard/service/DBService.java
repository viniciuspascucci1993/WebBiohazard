...
public class DBService {
	...
	public void instanciateDataBase() throws ParseException {
		...
		Weapon weapon2 = new Weapon(null, "Espingarda Remington M870 (Shotgun)", 2200.00, "Barry Burton", LocalDate.of(1977, 02, 4), weaponCategory);
		
		
		Weapon weapon3 = new Weapon(null, "Colt Python (Magnum)", 2700.00, "Barry Burton", LocalDate.of(1964, 01, 12), weaponCategory2);
		
		
		Weapon weapon4 = new Weapon(null, "Bazuca (Bazooka)", 5500.00, "Mikhail Victor", LocalDate.of(1861, 01, 04), weaponCategory3);
		
		Weapon weapon5 = new Weapon(null, "SURVIVAL KNIFE", 5.00, "Mikhail Victor", LocalDate.of(1861, 01, 04), weaponCategory4);
		
		Weapon weapon6 = new Weapon(null, "DAGGER", 5.00, "Chris Retfield", LocalDate.of(1861, 01, 04), weaponCategory4);
		...
		weaponCategory.getWeapon().addAll(Arrays.asList(weapon, weapon2));
		weaponCategory2.getWeapon().addAll(Arrays.asList(weapon2));
		weaponCategory3.getWeapon().addAll(Arrays.asList(weapon3));
		weaponCategory4.getWeapon().addAll(Arrays.asList(weapon5, weapon6));
		...
		this.weaponRepository.saveAll(Arrays.asList(weapon, weapon2, weapon3, weapon4, weapon5, weapon6));
